Contributing to Bitcoin Turbo Koin Core
============================

The Bitcoin Turbo Koin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Bitcoin Turbo Koin Core project, and is not to be
confused with overall BTK Network Protocol consensus changes.

Whether a pull request is merged into Bitcoin Turbo Koin Core rests with the project merge
...
Patches that change BTK consensus rules are considerably more involved than
...
Where a patch set proposes to change the BTK consensus, it must have been
...
The project leader is the release manager for each Bitcoin Turbo Koin Core release.
