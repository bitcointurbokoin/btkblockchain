...
/* Bitcoin Turbo Koin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "BTK"
#define QAPP_ORG_DOMAIN "btk.org"
#define QAPP_APP_NAME_DEFAULT "Bitcoin-Turbo-Koin-Core"
#define QAPP_APP_NAME_TESTNET "Bitcoin-Turbo-Koin-Core-testnet"
