                                                                                                            ...
                                                                                                            fCapsLock(false)
{
    ...
    // It doesn't make sense to show the checkbox for sending BTK because you wouldn't check it anyway.
    if (context == Context::Send_BTK) {
...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        QMessageBox::StandardButton retval = QMessageBox::question(this, tr("Confirm wallet encryption"),
            tr("Warning: If you encrypt your wallet and lose your passphrase, you will <b>LOSE ALL OF YOUR BTK</b>!") + "<br><br>" + tr("Are you sure you wish to encrypt your wallet?"),
            ...
            if (newpass1 == newpass2) {
                if (model->setWalletEncrypted(true, newpass1)) {
                    QMessageBox::warning(this, tr("Wallet encrypted"),
                        "<qt>" +
                            tr("BTK will close now to finish the encryption process. "
                               "Remember that encrypting your wallet cannot fully protect "
                               "your BTKs from being stolen by malware infecting your computer.") +
                            "<br><br><b>" +
