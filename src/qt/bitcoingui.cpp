                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Bitcoin Turbo Koin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BTK address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and btk: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Bitcoin Turbo Koin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Bitcoin Turbo Koin Core"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for BTK"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BTK addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BTK addresses"));
    ...
    openAction->setStatusTip(tr("Open a BTK: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Bitcoin Turbo Koin Core help message to get a list with possible BTK command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Bitcoin Turbo Koin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BTK network", "", count));
}
...
{
    QString strTitle = tr("Bitcoin Turbo Koin Core"); // default title
