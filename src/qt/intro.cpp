...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Bitcoin Turbo Koin Core"),
     ...
     * override -datadir in the btk.conf file in the default data directory
     * (to be consistent with btkd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
