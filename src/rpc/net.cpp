...
UniValue getpeerinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "    \"subver\": \"/Bitcoin Turbo Koin Core:x.x.x.x/\",  (string) The string version\n"
...
UniValue addnode(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 2 ||
        ...
        throw runtime_error(
            ...
            "\nExamples:\n" +
            HelpExampleCli("addnode", "\"192.168.0.6:41242\" \"onetry\"") + HelpExampleRpc("addnode", "\"192.168.0.6:41242\", \"onetry\""));
...
UniValue getaddednodeinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "    \"addresses\" : [\n"
            "       {\n"
            "         \"address\" : \"192.168.0.201:41242\",  (string) The btk server host and port\n"
...
UniValue getnetworkinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"subversion\": \"/Bitcoin Turbo Koin Core:x.x.x.x/\",     (string) the server subversion string\n"
            ...
            "  ,...\n"
            "  ],\n"
            "  \"relayfee\": x.xxxxxxxx,                (numeric) minimum relay fee for non-free transactions in btk/kb\n"
