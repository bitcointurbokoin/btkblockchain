...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BTK features */
        {"btk", "masternode", &masternode, true, true, false},
        {"btk", "listmasternodes", &listmasternodes, true, true, false},
        {"btk", "getmasternodecount", &getmasternodecount, true, true, false},
        {"btk", "masternodeconnect", &masternodeconnect, true, true, false},
        {"btk", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"btk", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"btk", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"btk", "masternodecurrent", &masternodecurrent, true, true, false},
        {"btk", "masternodedebug", &masternodedebug, true, true, false},
        {"btk", "startmasternode", &startmasternode, true, true, false},
        {"btk", "createmasternodekey", &createmasternodekey, true, true, false},
        {"btk", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"btk", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"btk", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"btk", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"btk", "getmasternodescores", &getmasternodescores, true, true, false},
        {"btk", "mnsync", &mnsync, true, true, false},
        {"btk", "spork", &spork, true, true, false},
        {"btk", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> btk-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:41243/\n";
}
