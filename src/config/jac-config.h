/* src/config/btk-config.h.  Generated from btk-config.h.in by configure.  */
/* src/config/btk-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "btk.org"
