...
This mechanism has been integrated into Bitcore-Node-BTK which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/BTK-Project/insight-api-btk#web-socket-api](https://github.com/BTK-Project/insight-api-btk#web-socket-api) 
* API: [https://github.com/BTK-Project/insight-api-btk#swifttx-transactions](https://github.com/BTK-Project/insight-api-btk#swifttx-transactions) 
...
By default, the Bitcoin Turbo Koin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Bitcoin Turbo Koin Core daemon:
